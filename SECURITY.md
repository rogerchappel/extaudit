...
Replace this section with the supported versions for `extaudit`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `extaudit` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in extaudit.
